...
class BaseAdminService extends BaseService {
	...
	async isAdmin(token) {
		...
		if (admin.ADMIN_PASSWORD) delete admin.ADMIN_PASSWORD;
		if (admin.ADMIN_TOKEN) delete admin.ADMIN_TOKEN;
		if (admin.ADMIN_TOKEN_TIME) delete admin.ADMIN_TOKEN_TIME;
